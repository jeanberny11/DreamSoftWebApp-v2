// catalog.types.ts — Shared Solutions/Plans/Pricing/Features catalog types
// Used by both the public landing pages (home feature) and authenticated
// tenant-control-panel features that need the same catalog data.
